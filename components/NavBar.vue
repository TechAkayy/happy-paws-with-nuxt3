...
<template>
    <div class="container mx-auto relative">
        <nav class="flex flex-wrap hidden items-center p-4">
            <NuxtLink to="/" class="font-bold font-serif hover:text-opacity-75 inline-flex items-center leading-none mr-4 text-gray-900 text-xl">
                ...
                </svg><span>Happy Paws</span>
            </NuxtLink>
            <button class="hover:bg-primary-500 hover:text-secondary-500 lg:hidden ml-auto px-3 py-2 rounded text-primary-500">
            ...
            <div class="flex-1 hidden space-y-2 w-full lg:flex lg:items-center lg:space-x-4 lg:space-y-0 lg:w-auto" data-name="nav-menu">
                <div class="flex flex-col ml-auto lg:flex-row">
                    <NuxtLink to="/" class="hover:text-primary-500 py-2 text-gray-500 lg:p-4">Home</NuxtLink>
                    <NuxtLink to="/adopt" class="hover:text-primary-500 py-2 text-gray-500 lg:p-4">Adopt</NuxtLink>
                    <NuxtLink to="/volunteer" class="hover:text-primary-500 py-2 text-gray-500 lg:p-4">Volunteer</NuxtLink>
                    <NuxtLink to="/about-us" class="hover:text-primary-500 py-2 text-gray-500 lg:p-4">Our Mission</NuxtLink>
                    <NuxtLink to="/blog" class="hover:text-primary-500 py-2 text-gray-500 lg:p-4">Blog</NuxtLink>
                </div>
                <NuxtLink to="/donate" class="bg-primary-500 hover:bg-primary-600 inline-block px-6 py-2 rounded-full text-center text-gray-900">Donate</NuxtLink>
            </div>
        </nav>
        <nav class="flex items-start justify-between lg:items-center p-4">
            ...
            <div class="absolute flex flex-col right-0 z-10 lg:static">
                <button class="hover:bg-primary-500 hover:text-secondary-500 ml-auto mr-4 px-3 py-2 rounded lg:hidden" :class="navOpenClass" @click="navOpen = !navOpen">
                ...
                <div class="bg-gray-100 flex flex-col items-end p-4 lg:flex-row lg:items-center lg:p-0" v-if="navOpenInSmallerThanlg">
                    <NuxtLink v-for="(nav, index) in navItemsFiltered" class="hover:text-primary-600 p-4" :to="nav.to" :class="{ 'text-primary-600': nav.to === currentRoutePath }" @click="navOpen = false"><span>{{ nav.name }}</span>
                    </NuxtLink>
                    <NuxtLink class="bg-primary-500 hover:bg-primary-600 ml-2 px-6 py-2 rounded-full text-center text-gray-900" to="/donate" :class="{ 'bg-primary-600': currentRoutePath === '/donate' }"><span>Donate</span>
                    </NuxtLink>
                </div>
            </div>
        </nav>

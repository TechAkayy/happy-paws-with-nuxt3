...
<template>
	<div class="container mx-auto relative">
		<nav class="flex items-start justify-between lg:items-center p-4">
			<NuxtLink
				to="/"
				class="capitalize flex font-bold font-serif hover:text-opacity-75 items-center text-gray-900 text-xl"
			>
				<svg
					version="1.0"
			...
			<div class="absolute flex flex-col right-0 z-10 lg:static">
				<button
					class="hover:bg-primary-500 hover:text-secondary-500 ml-auto mr-4 px-3 py-2 rounded lg:hidden"
					:class="navOpenClass"
				...
				<div
					...
					v-if="navOpenInSmallerThanlg"
				>
					<NuxtLink
						v-for="(nav, index) in navItemsFiltered"
						class="hover:text-primary-600 p-4"
						:to="nav.to"
					...
					<NuxtLink
						class="bg-primary-500 hover:bg-primary-600 ml-2 px-6 py-2 rounded-full text-center text-gray-900"
						to="/donate"

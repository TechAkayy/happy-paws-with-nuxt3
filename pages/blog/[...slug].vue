...
<!-- <style scoped lang="postcss">
  .blog-link {
    @apply prose-a:text-primary-500 before:prose-headings:content-['#'] before:prose-headings:mr-1 before:prose-headings:text-primary-500 before:prose-h1:content-[''];
  }
</style> -->
